...
import { RewindIcon, SwitchHorizontalIcon, FastForwardIcon, PauseIcon, ReplyIcon, PlayIcon, VolumeUpIcon } from "@heroicons/react/solid";
    ...
    return (
        <div className="h-24 bg-gradient-to-b from-black to-gray-900 text-white grid grid-cols-3 text-xs md:text-base px-2 md:px-8">
            ...
            <div className="flex items-center justify-evenly">
                ...
                <RewindIcon
                    // onClick={() => spotifyApi.skipToPrevious()} --the api is not work
                    className="button" />
                ...
                <FastForwardIcon
                    // onClick={() => spotifyApi.skipToNext()} --the api is not work
                    className="button" />
